...
## **Pendahuluan**
Bagian ini merupakan bentuk R Makdwon tentang EDA & Data Preprocessing
...
```{r}
df  <- read.csv("https://raw.githubusercontent.com/Iprass30/Kelas-Mahir-Pejuang-Data-2.0/main/titanic_modify%20baru.csv", stringsAsFactors = T)
df[0:5,]
```
